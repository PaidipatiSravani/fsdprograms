                ...
                <div className='secondcard'>
                    <div className="card"  >
                        <div className="card-body" >
                            <div>
                                <h5 style={{ color: "black",textAlign:'left' }}>Accounts Details</h5>
                                <input type="button" value={"Local"} data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample" />
                                <input type="button" value={"Swift"} />
                            </div>
                            <div className="collapse" id="collapseExample2">
                                <div className="card-body" >
                                    <div className='local'>
                                        <ul>
                                            <li className="list-group-item">
                                                Beneficiary<br /><h6>John Doe</h6>Account<br /><h6>25451843254</h6>Sort Code<br /><h6>05-254518-578458</h6>
                                            </li>
                                            <li className="list-group-item">
                                                <i className='fas fa-coins'></i> Use this personal current account to get salary and to pay bills<br /><br />
                                                <i class="fa fa-clock"></i>   Transfers usually take a few hours to appear on your PayVoo account<br /><br />
                                                ...
                                                </svg>Only local transfers are accepted. <br />
                                                <br />
